...
//         }
      ...
      steps {
       nexusPublisher nexusInstanceId: 'nexusid', nexusRepositoryId: 'pipeline', packages: [[$class: 'MavenPackage', mavenAssetList: [[classifier: '', extension: '', filePath: 'pline-sonar-docker-k8s/target/vprofile-v1.war']], mavenCoordinate: [artifactId: 'vprofile', groupId: 'com.wakaleo.gameoflife', packaging: 'war', version: '$BUILD_NUMBER']]]      
      }
     }
